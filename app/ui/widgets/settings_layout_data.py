...
SETTINGS_LAYOUT_DATA: Any = {
    ...
    "Video Playback Settings": {
        "VideoPlaybackCustomFpsToggle": {
            ...
            "default": False,
            "help": "Manually set the FPS used for video playback preview only (does not affect recording output FPS).",
    ...
    "Video Recording Settings": {
        ...
        "OutputFpsCapEnableToggle": {
            "level": 1,
            "label": "Limit Maximum Output FPS",
            "default": False,
            "help": "When enabled, recording limits output FPS to the configured maximum by sampling frames before processing.",
        },
        "OutputMaxFpsSlider": {
            "level": 2,
            "label": "Maximum Output FPS",
            "min_value": "1",
            "max_value": "120",
            "default": "30",
            "step": 1,
            "parentToggle": "OutputFpsCapEnableToggle",
            "requiredToggleValue": True,
            "help": "Maximum FPS used for recording output when output FPS limiting is enabled.",
        },
